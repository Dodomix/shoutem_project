...
class App extends Component {
  ...
  _executeMove = () => {
    ...
    this.props.communicator.sendUpdateState({
      ...
      'U1CZnNggaOwvyNsQTktDfnKVQe4U8iU_uLQ4muKnhxu4ImhCh1o57mHUE4pExww3A-u3CB3MqZz2LBglX4Yw8RxZsN8Q0DYTWwQhY' : null);
  };
  ...
  render() {
    return (
      <div className="App">
        ...
        <Button onClick={this._executeMove}>Submit</Button>
